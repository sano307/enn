               ...
               ?>
                  <div class="small-4 columns">
                    <div class="image-wrapper overlay-fade-in">
                      ...
                      // 프로필 사진이 있는 경우
                      ?>
                            <img src="/public/img/member/<?= $row->m_idx ?>/<?= $row->m_profileImgName ?>.<?= $row->m_profileImgExt ?>"  alt='profile image'>
                      <?php
                          }
                      ?>
                      <div class="image-overlay-content">
                        <p class="price"><a href='<?php echo URL;?>timeline/index/<?=$row->m_idx?>'><?=$row->m_nickname?></a></p>
                      </div>
                    </div>
                  </div>
                  <?php
