...
<script src="<?php echo base_url(); ?>assets/js/start/route.js"></script>
<script src="<?php echo base_url(); ?>assets/js/start/controller.js"></script>
<script src="<?php echo base_url(); ?>assets/js/start/directive.js"></script>
</body>
</html>